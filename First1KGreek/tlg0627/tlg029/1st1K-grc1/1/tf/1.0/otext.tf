...
@editor=Émile Littré
@filename=tlg0627.tlg029.1st1K-grc1
@fmt:text-orig-full={pre}{orig}{post}
@fmt:text-orig-main={main} 
@fmt:text-orig-plain={plain} 
@funder=Andrew W. Mellon Foundation
@principal=Gregory Crane
@publicationStmt=A Digital Corpus for Graeco-Arabic Studies, funded by the Andrew W. Mellon Foundation, University of Leipzig, Germany, tlg0627.tlg029.1st1K-grc1.xml.
...
@sourceDesc=Oeuvres complètes d'Hippocrate, Hippocrates, Émile Littré, Baillière, Paris, 6, 436-444, 1849, HathiTrust.
