...
@sectionFeatures=book,aphorism
@sectionTypes=book,aphorism
...
@structureFeatures=_book,book,aphorism,_sentence,_phrase
@structureTypes=_book,book,aphorism,_sentence,_phrase
@title=Aphorismi
@valueType=str
