...
@editor=A. M. Harmon
@filename=tlg0062.tlg034.1st1K-grc1
@funder=Harvard Library Arcadia Fund
@principal=Gregory Crane
@publicationStmt=Harvard College Library, tlg0062.tlg034.1st1K-grc1.xml.
...
7360	urn:cts:greekLit:tlg0062.tlg034.1st1K-grc1
