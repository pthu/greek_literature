...
@description=Calumniae non temere credendum, Slander
@editor=A. M. Harmon
@filename=tlg0062.tlg013.1st1K-grc1
@funder=Harvard Library Arcadia Fund
@principal=Gregory Crane
@publicationStmt=Harvard College Library, tlg0062.tlg013.1st1K-grc1.xml.
...
3144	Calumniae non temere credendum, Slander
