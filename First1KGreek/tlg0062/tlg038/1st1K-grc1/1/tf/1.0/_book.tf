...
@description=Alexander, Alexander the False Prophet
@editor=A. M. Harmon
@filename=tlg0062.tlg038.1st1K-grc1
@funder=Harvard Library Arcadia Fund
@principal=Gregory Crane
@publicationStmt=Harvard College Library, tlg0062.tlg038.1st1K-grc1.xml.
...
6932	Alexander, Alexander the False Prophet
