...
@description=Symposium, The Carousal, or The Lapiths
@editor=A. M. Harmon
@filename=tlg0062.tlg015.1st1K-grc1
@funder=Harvard Library Arcadia Fund
@principal=Gregory Crane
@publicationStmt=Harvard College Library, tlg0062.tlg015.1st1K-grc1.xml.
...
4709	Symposium, The Carousal, or The Lapiths
