...
@editor=A. M. Harmon
@filename=tlg0062.tlg052.1st1K-grc1
@funder=Harvard Library Arcadia Fund
@principal=Gregory Crane
@publicationStmt=Harvard College Library, tlg0062.tlg052.1st1K-grc1.xml.
...
5596	urn:cts:greekLit:tlg0062.tlg052.1st1K-grc1
