...
@sectionFeatures=commentary,book,paragraph
@sectionTypes=commentary,book,paragraph
...
@structureFeatures=_book,commentary,book,paragraph,_sentence,_phrase
@structureTypes=_book,commentary,book,paragraph,_sentence,_phrase
@title=In XII Prophetas
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T15:01:12Z
