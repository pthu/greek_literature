...
@filename=tlg0086.tlg001.1st1K-grc1
@fmt:text-orig-full={pre}{orig}{post}
@fmt:text-orig-main={main} 
@fmt:text-orig-plain={plain} 
@funder=Andrew W. Mellon Foundation
@principal=Gregory Crane
@publicationStmt=A Digital Corpus for Graeco-Arabic Studies, funded by the Andrew W. Mellon Foundation, University of Leipzig, Germany, tlg0086.tlg001.1st1K-grc1.xml.
...
@sectionFeatures=book,part,chapter
@sectionTypes=book,part,chapter
@sourceDesc=Aristotelis Opera, Aristotle, Immanuel Bekker, Oxford University Press, Oxford, 1, 61-181, 1837, HathiTrust.
@sponsor=Harvard College Library
@structureFeatures=_book,book,part,chapter,_sentence,_phrase
@structureTypes=_book,book,part,chapter,_sentence,_phrase
@title=Analytica priora
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:50:45Z
