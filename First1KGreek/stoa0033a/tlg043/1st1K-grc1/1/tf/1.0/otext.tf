...
@filename=stoa0033a.tlg043.1st1K-grc1
@fmt:text-orig-full={pre}{orig}{post}
@fmt:text-orig-main={main} 
@fmt:text-orig-plain={plain} 
@funder=Andrew W. Mellon Foundation
@principal=Gregory Crane
@publicationStmt=A Digital Corpus for Graeco-Arabic Studies, funded by the Andrew W. Mellon Foundation, University of Leipzig, Germany, stoa0033a.tlg043.1st1K-grc1.xml.
...
@sourceDesc=Aristotelis Opera, pseudo-Aristotle, Immanuel Bekker, Oxford University Press, Oxford, 3, 355-367, 1837, HathiTrust.
...
@dateWritten=2020-12-11T15:07:45Z
