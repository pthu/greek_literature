...
@sectionFeatures=book,fragment
@sectionTypes=book,fragment
@sourceDesc=Philodemi Volumina rhetorica, Siegfried Sudhaus, Philodemus, Teubner, Leipzig, 1895, 3, The Internet Archive.
@sponsor=University of Leipzig
@structureFeatures=_book,book,fragment,_sentence,_phrase
@structureTypes=_book,book,fragment,_sentence,_phrase
