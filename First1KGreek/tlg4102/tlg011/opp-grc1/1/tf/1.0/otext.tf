...
@sectionFeatures=chapter,verse,comment
@sectionTypes=chapter,verse,comment
...
@structureFeatures=_book,chapter,verse,comment,_sentence,_phrase
@structureTypes=_book,chapter,verse,comment,_sentence,_phrase
@title=Catena In Epistulam Ad Romanos (typus Monacensis)
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:59:02Z
