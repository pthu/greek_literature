...
@filename=tlg4102.tlg008.opp-grc1
...
@publicationStmt=University of Leipzig, tlg4102.tlg008.opp-grc1.xml.
...
@sourceDesc=John Anthony Cramer, Catenæ Græcorum Patrum in Novum Testamentum, In Acta Ss. Apostolorum, Oxford University Press, Oxford, 1844, 3, Internet Archive.
