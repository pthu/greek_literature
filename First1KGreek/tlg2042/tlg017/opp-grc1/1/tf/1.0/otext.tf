...
@sectionFeatures=book,fragment,section
@sectionTypes=book,fragment,section
@sourceDesc=Origenes Werke, Max Rauer, Origenes, J. C. Hinrichs'Sche Buchhandlung, Leipzig, 1930, vol. 9, Internet Archive.
@sponsor=University of Leipzig
@structureFeatures=_book,book,fragment,chapter,section,_sentence,_phrase
@structureTypes=_book,book,fragment,chapter,section,_sentence,_phrase
@title=Fragmenta in Lucam (in catenis)
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T15:10:57Z
