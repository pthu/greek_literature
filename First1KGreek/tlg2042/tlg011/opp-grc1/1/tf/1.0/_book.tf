...
@description=Fragmenta In Lamentationes (In Catenis de Prophetis)
@editor=Erich Klostermann
@filename=tlg2042.tlg011.opp-grc1
@funder=European Social Fund Saxony
@principal=Gregory Crane, Monica Berti
@publicationStmt=University of Leipzig, tlg2042.tlg011.opp-grc1.xml.
...
@dateWritten=2020-12-11T15:08:49Z

10345	Fragmenta In Lamentationes (In Catenis de Prophetis)
