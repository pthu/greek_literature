...
@filename=tlg2042.tlg008.perseus-grc1
...
@sourceDesc=Origenes Werke, Paul Koetschau, Origenes, J.C. Hinrich'sche Buchhandlung, Leipzig, 1899, vol. 2, Internet Archive.
