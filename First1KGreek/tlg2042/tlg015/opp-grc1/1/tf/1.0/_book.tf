...
@description=Fragmentum In Librum Primum Regnorum (In Catenis de Cantico Canticorum)
@editor=Erich Klostermann
@filename=tlg2042.tlg015.opp-grc1
@funder=European Social Fund Saxony
@principal=Gregory Crane, Monica Berti
@publicationStmt=University of Leipzig, tlg2042.tlg015.opp-grc1.xml.
...
84	Fragmentum In Librum Primum Regnorum (In Catenis de Cantico Canticorum)
