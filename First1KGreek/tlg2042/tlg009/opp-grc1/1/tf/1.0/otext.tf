...
@sectionFeatures=homilia,section
@sectionTypes=homilia,section
...
@structureFeatures=_book,homilia,section,_sentence,_phrase
@structureTypes=_book,homilia,section,_sentence,_phrase
