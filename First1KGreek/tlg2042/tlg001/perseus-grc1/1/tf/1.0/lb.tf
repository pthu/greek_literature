...
@filename=tlg2042.tlg001.perseus-grc1
...
@sourceDesc=Origenes Werke, Origenes, Paul Koetschau, J. C. Hinrichs'sche Buchhandlung, Leipzig, 1899, 1-2, Internet Archive.
@sponsor=University of Leipzig
@title=Contra Celsum
@valueType=int
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T15:09:43Z
