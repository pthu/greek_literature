...
@sectionFeatures=chapter,paragraph
@sectionTypes=chapter,paragraph
...
@structureFeatures=_book,chapter,paragraph,_sentence,_phrase
@structureTypes=_book,chapter,paragraph,_sentence,_phrase
