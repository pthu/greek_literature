...
@sectionFeatures=book,section,fragment
@sectionTypes=book,section,fragment
...
@structureFeatures=_book,book,section,fragment,_sentence,_phrase
@structureTypes=_book,book,section,fragment,_sentence,_phrase
@title=Commentarii in Evangelium Joannis
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T15:12:03Z
