...
@sectionFeatures=work,chapter
@sectionTypes=work,chapter
...
@structureFeatures=_book,work,chapter,_sentence,_phrase
@structureTypes=_book,work,chapter,_sentence,_phrase
