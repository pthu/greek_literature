...
@sectionFeatures=haeresis,chapter,section
@sectionTypes=haeresis,chapter,section
...
@structureFeatures=_book,haeresis,chapter,section,_sentence,_phrase
@structureTypes=_book,haeresis,chapter,section,_sentence,_phrase
@title=Panarion (Adversus haereses)
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:55:03Z
