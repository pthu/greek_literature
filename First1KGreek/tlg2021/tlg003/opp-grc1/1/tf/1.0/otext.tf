...
@sectionFeatures=haeresis,section
@sectionTypes=haeresis,section
...
@structureFeatures=_book,haeresis,section,_sentence,_phrase
@structureTypes=_book,haeresis,section,_sentence,_phrase
