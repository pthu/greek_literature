...
@sectionFeatures=chapter,letter,section
@sectionTypes=chapter,letter,section
@sourceDesc=EPIPHANIUS, D.DR. KARL HOLL, D.DR. KARL HOLL, J. C. HINRICHS'SCHE BUCHHANDLUNG, LEIPZIG, 1915, vol.
@sponsor=University of Leipzig
@structureFeatures=_book,chapter,letter,section,_sentence,_phrase
@structureTypes=_book,chapter,letter,section,_sentence,_phrase
@title=EPIPHANIUS
@valueType=str
