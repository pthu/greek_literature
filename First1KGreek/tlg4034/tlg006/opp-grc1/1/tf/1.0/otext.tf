...
@publicationStmt=University of Leipzig, tlg4034.tlg006.opp-grc1.xml.
...
@sectionFeatures=commentary,chapter
@sectionTypes=commentary,chapter
@sourceDesc=Michaelis Ephesii in librum quintum ethicorum Nicomacheorum commentarium, Paulus Wendland, Paul Wendland, Michael Ephesius, Reimer, Berlin, 1901, Commetaria in Aristotelem Graeca, 22.3, Internet Archive.
@sponsor=University of Leipzig
@structureFeatures=_book,commentary,chapter,_sentence,_phrase
@structureTypes=_book,commentary,chapter,_sentence,_phrase
