...
@sectionFeatures=book,paragraph,section
@sectionTypes=book,paragraph,section
...
@structureFeatures=_book,book,paragraph,section,_sentence,_phrase
@structureTypes=_book,book,paragraph,section,_sentence,_phrase
@title=Ex Agatharchidis De Maris Erythraeo Libri Excerpta
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T15:11:07Z
