...
@description=De Creatis (Fragmenta Ap. Photium, Bibl. Cod. 235)
...
@publicationStmt=University of Leipzig, tlg2959.tlg005.opp-grc1.xml.
...
1859	De Creatis (Fragmenta Ap. Photium, Bibl. Cod. 235)
