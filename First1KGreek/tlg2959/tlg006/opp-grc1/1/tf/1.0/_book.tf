...
@description=Adversus Porphyrium (Fragmenta)
...
@publicationStmt=University of Leipzig, tlg2959.tlg006.opp-grc1.xml.
...
@title=Adversus Porphyrium (Fragmenta)
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:50:31Z

1223	Adversus Porphyrium (Fragmenta)
