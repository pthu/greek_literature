...
@description=De Martyribus (Fragmenta)
@editor=D.G. Nathanael Bonwetsch
@filename=tlg2959.tlg008.opp-grc1
@funder=European Social Fund Saxony
@principal=Gregory Crane, Monica Berti
@publicationStmt=University of Leipzig, tlg2959.tlg008.opp-grc1.xml.
