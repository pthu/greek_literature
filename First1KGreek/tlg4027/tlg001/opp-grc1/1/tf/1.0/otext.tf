...
@sectionFeatures=chapter,index,commentary
@sectionTypes=chapter,index,commentary
...
@structureFeatures=_book,chapter,index,addenda,preface,commentary,_sentence,_phrase
@structureTypes=_book,chapter,index,addenda,preface,commentary,_sentence,_phrase
