...
@description=Περὶ γάμου καὶ συμβιώσεως
@editor=August Lentz
@filename=tlg0087.tlg029.1st1K-grc1
@funder=Harvard Library Arcadia Fund
@principal=Gregory Crane
@publicationStmt=Harvard College Library, tlg0087.tlg029.1st1K-grc1.xml.
...
@dateWritten=2020-12-11T14:58:16Z

60	Περὶ γάμου καὶ συμβιώσεως
