...
@description=Μονόβιβλον περὶ τοῦ ἦν
@editor=August Lentz
@filename=tlg0087.tlg020.1st1K-grc1
@funder=Harvard Library Arcadia Fund
@principal=Gregory Crane
@publicationStmt=Harvard College Library, tlg0087.tlg020.1st1K-grc1.xml.
