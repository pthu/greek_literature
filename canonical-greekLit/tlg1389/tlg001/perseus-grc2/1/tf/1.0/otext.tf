...
@sectionFeatures=letter,entry
@sectionTypes=letter,entry
...
@structureFeatures=_book,letter,entry,_sentence,_phrase
@structureTypes=_book,letter,entry,_sentence,_phrase
