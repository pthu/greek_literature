...
@sectionFeatures=section,part
@sectionTypes=section,part
...
@structureFeatures=_book,section,part,_sentence,_phrase
@structureTypes=_book,section,part,_sentence,_phrase
