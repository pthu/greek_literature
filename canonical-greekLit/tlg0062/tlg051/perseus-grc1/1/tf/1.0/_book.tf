...
@description=Tyrannicida, Machine readable text
@editor=A. M. Harmon
@filename=tlg0062.tlg051.perseus-grc1
...
@title=Tyrannicida, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:35:58Z

2889	Tyrannicida, Machine readable text
