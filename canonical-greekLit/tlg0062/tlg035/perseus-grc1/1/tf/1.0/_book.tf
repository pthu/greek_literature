...
@description=Necyomantia, Machine readable text
@editor=A. M. Harmon
@filename=tlg0062.tlg035.perseus-grc1
...
@title=Necyomantia, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:35:42Z

3324	Necyomantia, Machine readable text
