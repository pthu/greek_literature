...
@description=Pseudologista, Machine readable text
@editor=A. M. Harmon
@filename=tlg0062.tlg049.perseus-grc1
...
@title=Pseudologista, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:36:11Z

3923	Pseudologista, Machine readable text
