...
@description=Judicium vocalium, Machine readable text
@editor=A. M. Harmon
@filename=tlg0062.tlg014.perseus-grc1
...
@title=Judicium vocalium, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:35:54Z

1146	Judicium vocalium, Machine readable text
