...
@sectionFeatures=chapter,fragment,section
@sectionTypes=chapter,fragment,section
@sourceDesc=Appian, The Foreign Wars, 04031898, L. Mendelssohn, Leipzig, Teubner, 1879.
@sponsor=Perseus Project, Tufts University
@structureFeatures=_book,chapter,fragment,section,_sentence,_phrase
@structureTypes=_book,chapter,fragment,section,_sentence,_phrase
