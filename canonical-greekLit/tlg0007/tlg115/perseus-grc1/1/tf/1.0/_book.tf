...
@description=Maxime cum principbus philosopho esse diserendum, Machine readable text
...
1774	Maxime cum principbus philosopho esse diserendum, Machine readable text
