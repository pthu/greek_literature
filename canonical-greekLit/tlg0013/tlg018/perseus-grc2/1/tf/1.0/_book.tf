...
@description=Hymn 18 To Hermes, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg018.perseus-grc2
...
@title=Hymn 18 To Hermes, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:26Z

79	Hymn 18 To Hermes, Machine readable text
