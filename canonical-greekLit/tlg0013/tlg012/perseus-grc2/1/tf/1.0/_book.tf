...
@description=Hymn 12 To Hera, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg012.perseus-grc2
...
@title=Hymn 12 To Hera, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:24Z

31	Hymn 12 To Hera, Machine readable text
