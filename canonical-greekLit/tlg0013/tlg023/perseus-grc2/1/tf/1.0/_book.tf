...
@description=Hymn 23 to Zeus, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg023.perseus-grc2
...
@title=Hymn 23 to Zeus, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:26Z

25	Hymn 23 to Zeus, Machine readable text
