...
@description=Hymn 28 To Athena, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg028.perseus-grc2
...
@title=Hymn 28 To Athena, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:28Z

114	Hymn 28 To Athena, Machine readable text
