...
@description=Hymn 10 To Aphrodite, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg010.perseus-grc2
...
@title=Hymn 10 To Aphrodite, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:24Z

42	Hymn 10 To Aphrodite, Machine readable text
