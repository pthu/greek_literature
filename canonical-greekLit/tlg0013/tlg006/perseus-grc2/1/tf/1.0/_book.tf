...
@description=Hymn 6 To Aphrodite, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg006.perseus-grc2
...
@title=Hymn 6 To Aphrodite, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:26Z

134	Hymn 6 To Aphrodite, Machine readable text
