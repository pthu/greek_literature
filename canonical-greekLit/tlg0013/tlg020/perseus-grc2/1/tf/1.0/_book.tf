...
@description=Hymn 20 To Hephaestus, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg020.perseus-grc2
...
@title=Hymn 20 To Hephaestus, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:24Z

54	Hymn 20 To Hephaestus, Machine readable text
