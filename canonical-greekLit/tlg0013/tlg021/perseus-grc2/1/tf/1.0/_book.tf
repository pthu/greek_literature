...
@description=Hymn 21 To Apollo, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg021.perseus-grc2
...
@title=Hymn 21 To Apollo, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:26Z

41	Hymn 21 To Apollo, Machine readable text
