...
@description=Hymn 30 To Earth, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg030.perseus-grc2
...
@title=Hymn 30 To Earth, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:28Z

136	Hymn 30 To Earth, Machine readable text
