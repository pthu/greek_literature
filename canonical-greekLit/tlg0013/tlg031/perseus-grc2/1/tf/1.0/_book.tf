...
@description=Hymn 31 To Helios, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg031.perseus-grc2
...
@title=Hymn 31 To Helios, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:26Z

134	Hymn 31 To Helios, Machine readable text
