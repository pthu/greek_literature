...
@description=Hymn 33 To the Dioscuri, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg033.perseus-grc2
...
@title=Hymn 33 To the Dioscuri, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:23Z

119	Hymn 33 To the Dioscuri, Machine readable text
