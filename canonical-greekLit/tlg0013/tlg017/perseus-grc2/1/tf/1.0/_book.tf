...
@description=Hymn 17 To the Dioscuri, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg017.perseus-grc2
...
@title=Hymn 17 To the Dioscuri, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:27Z

30	Hymn 17 To the Dioscuri, Machine readable text
