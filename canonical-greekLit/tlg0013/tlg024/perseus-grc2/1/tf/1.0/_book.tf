...
@description=Hymn 24 To Hestia, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg024.perseus-grc2
...
@title=Hymn 24 To Hestia, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:23Z

35	Hymn 24 To Hestia, Machine readable text
