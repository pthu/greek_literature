...
@description=Hymn 26 To Dionysus, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg026.perseus-grc2
...
@title=Hymn 26 To Dionysus, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:24Z

92	Hymn 26 To Dionysus, Machine readable text
