...
@description=Hymn 9 To Artemis, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg009.perseus-grc2
...
@title=Hymn 9 To Artemis, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:23Z

60	Hymn 9 To Artemis, Machine readable text
