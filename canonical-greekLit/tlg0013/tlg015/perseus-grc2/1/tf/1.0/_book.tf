...
@description=Hymn 15 To Heracles the Lion-Hearted, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg015.perseus-grc2
...
@title=Hymn 15 To Heracles the Lion-Hearted, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:23Z

64	Hymn 15 To Heracles the Lion-Hearted, Machine readable text
