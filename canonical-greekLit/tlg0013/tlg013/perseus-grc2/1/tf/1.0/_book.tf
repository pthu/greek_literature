...
@description=Hymn 13 To Demeter, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg013.perseus-grc2
...
@title=Hymn 13 To Demeter, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:28Z

23	Hymn 13 To Demeter, Machine readable text
