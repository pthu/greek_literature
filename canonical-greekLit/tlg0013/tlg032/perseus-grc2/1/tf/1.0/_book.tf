...
@description=Hymn 32 To Selene, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg032.perseus-grc2
...
@title=Hymn 32 To Selene, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:26Z

127	Hymn 32 To Selene, Machine readable text
