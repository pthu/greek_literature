...
@description=Hymn 8 To Ares, Machine readable text
@editor=Hugh G. Evelyn-White
@filename=tlg0013.tlg008.perseus-grc2
...
@title=Hymn 8 To Ares, Machine readable text
@valueType=str
@writtenBy=Text-Fabric
@dateWritten=2020-12-11T14:45:23Z

102	Hymn 8 To Ares, Machine readable text
