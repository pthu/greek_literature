...
@sectionFeatures=poem,strophe
@sectionTypes=poem,strophe
...
@structureFeatures=_book,poem,strophe,_sentence,_phrase
@structureTypes=_book,poem,strophe,_sentence,_phrase
